...
This widget displays the device’s current connection status as a text label. For example: online/offline.

<figure><img src="../../../.gitbook/assets/connection-status-mobile-header-widget.png" alt=""><figcaption></figcaption></figure>
