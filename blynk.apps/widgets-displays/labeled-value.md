...
Displays the latest datastream / virtual pin value formatted according to a format string defined in the widget settings. Units assigned to the datastream are also displayed. Labels may also be optionally added before and after the displayed value.&#x20;
