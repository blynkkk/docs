...
13. Set [Notifications Limit](../blynk.console/templates/events/notification-limit.md) if necessary and turn on [Notifications management](notification-management.md)
