...
[Blynk.Console](../blynk.console/) allows you to create a digital model of your product for web and mobile platforms.

Please follow these steps to create your product [Template](https://docs.blynk.io/en/blynk.console/templates) and configure it's basic functions:
...
1. Open [Templates](https://docs.blynk.io/en/blynk.console/templates) section
...
4. Provide basic [Information](https://docs.blynk.io/en/blynk.console/templates/info) about the product you want to create:
...
5. Set up your product's [Metadata](https://docs.blynk.io/en/blynk.console/templates/metadata) that will describe user's device or environment settings.
...
6. Configure [Datastreams](../blynk.console/templates/datastreams/) that you would like to use with your product Devices.
...
7. Create [Events](https://docs.blynk.io/en/blynk.console/templates/events) for your product if you want to monitor devices current status and inform about important events.
...
8. Set up [Dashboard](https://docs.blynk.io/en/blynk.console/templates/dashboard) for your product that will ease your devices interaction for users
...
2. Specify [TMPLID](https://docs.blynk.io/en/blynk.console/templates/info/template-ids), [SSID WiFi](../blynk.console/templates/info/hotspot-prefix.md) and Board Name in the [sketch](connecting-arduino-devices.md)
