...
Blynk also offers a white-label solution as part of the [Enterprise Plan](https://blynk.io/pricing), allowing you to customize the app with your company logo, app icon, theme, colors, and publish it on App Store and Google Play under your company's name. These customized apps will work seamlessly with your devices.

To use Blynk.Apps, [install Blynk app on your iOS or Android device](downloads/blynk-apps-for-ios-and-android.md). For comprehensive [documentation on Blynk.Apps](https://app.gitbook.com/s/-MBFTVMf7L6S67HOuqVC/blynk.apps), refer to the provided link.
...
For [detailed information on Blynk.Edgent](https://app.gitbook.com/s/-MBFTVMf7L6S67HOuqVC/blynk.edgent), refer to the provided documentation.
...
Explore [Blynk Library documentation](https://app.gitbook.com/s/-MBFTVMf7L6S67HOuqVC/blynk-library-firmware-api) for further details.
