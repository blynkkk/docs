...
* [Platform API](blynk.cloud/organization-https-api/README.md)
  ...
  * [Ogranization API](blynk.cloud/organization-https-api/ogranization-api/README.md)
    ...
    * [Get Static Tokens](blynk.cloud/organization-https-api/ogranization-api/get-static-tokens.md)
    * [Get Organization Tags](blynk.cloud/organization-https-api/ogranization-api/get-organization-tags.md)
    * [Get Organization Automations](blynk.cloud/organization-https-api/ogranization-api/get-organization-automations.md)
  * [Devices API](blynk.cloud/organization-https-api/devices-api/README.md)
    * [Get All Devices](blynk.cloud/organization-https-api/devices-api/get-all-devices.md)
    * [Search Devices](blynk.cloud/organization-https-api/devices-api/search-devices.md)
    * [Get Recently Activated Devices](blynk.cloud/organization-https-api/devices-api/get-recently-activated-devices.md)
    * [Get Device Info](blynk.cloud/organization-https-api/devices-api/get-device-info.md)
    * [Get Connection Status](blynk.cloud/organization-https-api/devices-api/get-connection-status.md)
    * [Create Device](blynk.cloud/organization-https-api/devices-api/create-device.md)
    * [Edit Device](blynk.cloud/organization-https-api/devices-api/edit-device.md)
    * [Get Datastream Values](blynk.cloud/organization-https-api/devices-api/get-datastream-values.md)
    * [Update Datastream Value](blynk.cloud/organization-https-api/devices-api/update-datastream-value.md)
    * [Update Multiple Datastreams Values](blynk.cloud/organization-https-api/devices-api/update-multiple-datastreams-values.md)
    * [Import Datastream Values](blynk.cloud/organization-https-api/devices-api/import-datastream-values.md)
    * [Update Datastream Property](blynk.cloud/organization-https-api/devices-api/update-datastream-property.md)
    * [Get Datastream Historical Data](blynk.cloud/organization-https-api/devices-api/get-datastream-historical-data.md)
    * [Get Device Metadata](blynk.cloud/organization-https-api/devices-api/get-device-metadata.md)
    * [Update Device Metadata](blynk.cloud/organization-https-api/devices-api/update-device-metadata.md)
    * [Get Device Tags](blynk.cloud/organization-https-api/devices-api/get-device-tags.md)
    * [Get Device Timeline Log](blynk.cloud/organization-https-api/devices-api/get-device-timeline-log.md)
    * [Log a Device Event](blynk.cloud/organization-https-api/devices-api/log-a-device-event.md)
    * [Get Actions Log](blynk.cloud/organization-https-api/devices-api/get-actions-log.md)
    * [Erase All Data](blynk.cloud/organization-https-api/devices-api/erase-all-data.md)
    * [Remove Device Owner](blynk.cloud/organization-https-api/devices-api/remove-device-owner.md)
    * [Transfer Device](blynk.cloud/organization-https-api/devices-api/transfer-device.md)
    * [Delete Device](blynk.cloud/organization-https-api/devices-api/delete-device.md)
  * [Users API](blynk.cloud/organization-https-api/users-api/README.md)
    * [Get All Users](blynk.cloud/organization-https-api/users-api/get-all-users.md)
    * [Search Users](blynk.cloud/organization-https-api/users-api/search-users.md)
    * [Create New User](blynk.cloud/organization-https-api/users-api/create-new-user.md)
    * [Invite User](blynk.cloud/organization-https-api/users-api/invite-user.md)
    * [Get User Info](blynk.cloud/organization-https-api/users-api/get-user-info.md)
  * [Templates API](blynk.cloud/organization-https-api/templates-api/README.md)
    * [Get All Templates](blynk.cloud/organization-https-api/templates-api/get-all-templates.md)
    * [Get Template Info](blynk.cloud/organization-https-api/templates-api/get-template-info.md)
