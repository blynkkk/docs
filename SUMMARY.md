...
* [Platform API](blynk.cloud/platform-https-api/README.md)
  ...
  * [Devices API](blynk.cloud/platform-https-api/devices-api/README.md)
    ...
    * [Get Devices by Owner Email](blynk.cloud/platform-https-api/devices-api/get-devices-by-owner-email.md)
    * [Get Devices in user organization](blynk.cloud/platform-https-api/devices-api/get-devices-in-organization.md)
    ...
    * [Get Basic Device Info](blynk.cloud/platform-https-api/devices-api/get-basic-device-info.md)
