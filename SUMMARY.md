...
* [Keep your void loop\(\) clean](legacy-platform/keep-your-void-loop-clean.md)
...
* [ESP8266 with AT firmware](legacy-platform/esp8266-with-at-firmware.md)
* [Bluetooth \(2.0 SPP, 4.0 LE\)](legacy-platform/bluetooth-2.0-spp-4.0-le.md)
* [USB Serial](legacy-platform/usb-serial.md)
* [BBC micro:bit + Arduino IDE](legacy-platform/bbc-micro-bit-+-arduino-ide.md)
* [Raspberry Pi and Blynk](legacy-platform/raspberry-pi-and-blynk.md)
* [Blynk and Raspberry Pi: Tips & Tricks](legacy-platform/blynk-and-raspberry-pi-tips-and-tricks.md)
* [How to install Node.js library on Linux](legacy-platform/how-to-install-node.js-library-on-linux.md)
* [Node.js vs. C++ library](legacy-platform/node.js-vs.-c++-library.md)
