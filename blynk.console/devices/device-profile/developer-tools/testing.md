...
The section provides code snippets for [firmware API](https://app.gitbook.com/s/-MBFTVMf7L6S67HOuqVC/blynk-library-firmware-api), [HTTP API](../../../../blynk.cloud/device-https-api/) and [MQTT API](../../../../blynk.cloud/device-mqtt-api/) that can be used to perform the actions that were configured in the interface above from the hardware.
