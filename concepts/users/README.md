...
Each role has a set of permissions. PRO and Enterprise plans allow editing permissions by role. Read more about it [here](../../blynk.console/settings/access.md).



### Group users into organizations

To simplify access management to devices PRO and Enterprise plan users can group their clients and devices into multi-level [organizations](../organizations.md).
