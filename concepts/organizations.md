...
{% hint style="info" %}
As a root-org admin you can create sub-organizations under the sub-organizations in your hierarchy if you [switch to the sub-organization](organizations.md#creating-a-sub-organization) that is planned to be the parent one. Then you can act as the admin if this cub-organization and [create the next-level sub-organization](organizations.md#creating-a-sub-organization) as usual.
{% endhint %}
